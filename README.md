...
Если nginx показывает ошибку 502 то нужно подождать до 10 минут пока Docker соберёт все контейнеры. Отслеживать можно по логу контейнера dockerized-laravel-app.
